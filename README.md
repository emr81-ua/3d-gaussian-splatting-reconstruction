...
Prefer a window? Double-click **`gui.bat`** (or run `python gui.py`): choose your photos, tweak the key COLMAP and Gaussian-Splatting settings, and watch the progress live.
